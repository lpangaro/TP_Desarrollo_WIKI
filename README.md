...
- Hash de contraseñas con **bcryptjs** (backend)  
- Validación de credenciales mediante **CredencialesInvalidasError.js**

### Validación de Datos
- Validación de datos de entrada utilizando **Schemas**:
  - `pedidoSchema.js`
  - `productoSchema.js`
  - `usuarioSchema.js`
  - `notificacionSchema.js`
...
### Paginación
- Implementación de paginación en **getProductos (servicios)**  
- Límite de resultados por página (**limit/offset**) para evitar sobrecargar la página
...
- **Domain:** Modelos de dominio con POO  
- **Handlers:** Procesamiento de errores  

### Gestión de Errores Centralizada
- Carpetas específicas por dominio de errores  
- Errores personalizados (`ProductoNoEncontradoError`, `PedidoNoCreadoError`, etc.)  
...
- API **RESTful**  
- Endpoints bien definidos (`endpoints.js`)  
- Separación de responsabilidades por ruta  
...
### Diseño Responsivo
- Uso de **media queries** para diferentes tamaños de pantalla:  
- Adaptación de componentes (navbar, cards, carrusel)

### Accesibilidad
- Labels **ARIA** en botones interactivos  
- Feedback visual (hover effects, transiciones CSS)  
...
- **Swagger** configurado (`swagger.js`)  
...
- **Tests de integración:**
  - `notificacionController.integration.test.js`
